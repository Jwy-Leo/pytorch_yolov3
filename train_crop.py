...
import dataset_crop as dataset
from utils import *
    ...
    loader = torch.utils.data.DataLoader(
        dataset.listDataset(testlist, shape=(init_width, init_height),
                       ...
                       transform=transforms.Compose([
                           transforms.ToTensor(),
                       ]), train=False,crop=FLAGS.crop_strategy),
...
if __name__ == '__main__':
    ...
    parser.add_argument("--crop_strategy",'-CROP',
        action="store_true", default=False, help='crop training')
